    ...
    >
      <div class="player-modal__inner centered">
        ...
        >
              ...
              <div class="player-modal__comments">
                ...
                >
                  <p class="player-modal__no-comments-header">
                    ...
                    <span>There is no comment this period</span>
                  </p>
                </div>
          ...
          <div class="player-modal__right player-modal__youtube">
            <div class="centered">
              YOUTUBE AREA
            </div>
          </div>
...
<script>
import Base from '@/page-resources/history/player/_base';
...
@import "@/page-resources/history/player/_style.scss";
@import "@/page-resources/history/player/_youtube.scss";
</style>